                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4 bg-cuarto">
                            ...
                            <div class="card-body">
                                ...
                                <form action="actualizar.php" id="actualizar-form" method="post">
                                    <!-- idproducto para actualizar el registro -->
                                    <!-- Para el input hidden -->
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" id='categoria' name='categoria' required>
                                            ...
                                            <!-- Codigo de la seleccion de categoria en php -->
                                            <?php include 'create_get.php'; ?>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="nombre" id="nombre" required value="<?php echo $array[1] ?>">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" class="form-control" name="precio" id="precio" required value="<?php echo $array[2] ?>">
                                    </div>
                                    <!-- Cantidad del producto -->
                                    <div class="mb-4">
                                        <label for="cantidad" class="form-label">Cantidad del producto</label>
                                        <input type="number" class="form-control" name="cantidad" id="cantidad" required value="<?php echo $array[3] ?>">
                                    </div>
                                    <!-- Descripcion del producto -->
                                    <div class="mb-4">
                                        <label for="descripcion" class="form-label">Descripcion del producto</label>
                                        <textarea class="form-control" name="descripcion" id="descripcion" rows="3" required><?php echo $array[4] ?></textarea>
                                    </div>
                                    <!-- Imagen del producto -->
                                    <div class="mb-4">
                                ...
                                <button type="button" class="btn btn-secondary btn-lg" onclick="regresar()">Cancelar</button>
                            </div>
                        </div>
                    </div>
                </main>
