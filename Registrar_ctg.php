...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="Registrar_ctg.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Registrar Categoria
                        </a>
        ...
        <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4 bg-cuarto">
                            ...
                            <div class="card-body">
                                <h2>Formulario de registro de categorias</h2>
                                <form action="crui/php/categoria.php" id="register-form" method="post" enctype="multipart/form-data">
                                    <!-- Nombre del producto -->
                                    <div class="mb-4">
                                    ...
                                    <!-- Boton de registrar -->
                                    <div class="d-grid">
                                        <button type="submit" class="btn button" name="registrar_producto">Registrar categoria</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script src="crui/javascript/categoria.js"></script>
